...
class Database
{
	...
	public boolean addFoodItem(String uri, String title, String description, String addtime, int pickup, float quantity, String location)
	{
		ContentValues contentValues = new ContentValues();
	...
	static class DBHelper extends SQLiteOpenHelper
	{
		...
		public void onCreate(SQLiteDatabase db)
		{
			...
			db.execSQL("create table FoodItems(id integer primary key autoincrement, uri text, title text, description text, addtime datetime, pickup int, quantity number, location text, shared bool)");
		}
